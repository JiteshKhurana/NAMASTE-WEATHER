async function getWeather() {
  try {
    ...
    <h3>Precipitation:${rainChance}%</h3>
    `;
    if (temp > 30) {
      document.getElementById("temp").innerHTML =
        `<h3>Weather Type: Sunny</h3>`;
